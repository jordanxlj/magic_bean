#ifndef ONE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
#define ONE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
...
class OneToOneSequencedBatchThroughputTest : public AbstractPerfTestDisruptor {
 public:
...
#endif //ONE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
