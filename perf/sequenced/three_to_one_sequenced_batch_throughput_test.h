#ifndef THREE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
#define THREE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
...
#include "support/value_batch_publisher.h"
#include "support/value_event.h"
#include "support/value_addition_event_handler.h"

class ThreeToOneSequencedBatchThroughputTest : public AbstractPerfTestDisruptor {
 public:
 ...
 private:
  ...
  ValueBatchPublisher* value_publishers_[3];
  std::vector<magic_bean::SequencePtr> gatings_sequences_;
};

#endif //THREE_TO_ONE_SEQUENCED_BATCH_THROUGHPUT_TEST_H_
